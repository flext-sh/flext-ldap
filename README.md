...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-ldap` self).
...
- Public extensions exposed by this project: `FlextLdapProtocols`, `FlextLdapService`, `FlextLdap`, `FlextLdapModelsLdap`, `FlextLdapLdap3Adapter`, `FlextLdapSettings` (+12 more).
