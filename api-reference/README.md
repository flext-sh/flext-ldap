...
2. `src/flext_ldap/__init__.py` exports
3. Module docstrings
...
- Primary facades: `FlextLdapConstants`, `FlextLdapLdap3Wrappers`, `FlextLdapSettings`, `FlextLdapTypes`, `FlextLdapModels`, `FlextLdapLdap3Adapter` (+12 more)
