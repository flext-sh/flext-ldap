...
# 🖥️ CLI TOOLS INTEGRATION (NEW - administrative capabilities)
...
LDAP_CORE_DEFAULT_BIND_DN=cn=admin,dc=example,dc=com
...
python scripts/test_algar_oud_mig_integration.py           # Test ALGAR migration
