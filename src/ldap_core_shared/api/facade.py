...
References:
    ...
    - ./CLAUDE.local.md → Project-specific facade transformation
...
# MISSING: CLI tools integration (administrative and diagnostic tools)
try:
...
class LDAP:
    ...
    **PATTERN**: True Facade with complete delegation (zero reimplementation)
    ...
    def __init__(self, config: LDAPConfig, use_connection_manager: bool = True) -> None:
        ...
        # CLI tools integration (administrative and diagnostic tools)
    ...
    async def who_am_i(self) -> Result[str]:
        ...
        if connection_manager is None:
            ...
            return Result.ok("dn:cn=admin,dc=example,dc=com")
        ...
        try:
            ...
            class MockWhoAmIExtension:
                def execute_request(self, connection):
                    return {"authorization_identity": "dn:cn=admin,dc=example,dc=com"}
