...
Usage Example:
    >>> from ldap_core_shared.protocols.sasl.context import SASLContext, SASLProperties
    >>>
    >>> # Create SASL context
...
from ldap_core_shared.protocols.sasl.exceptions import SASLSecurityError
