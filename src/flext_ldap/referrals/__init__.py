...
Usage Example:
    >>> from flext_ldap.referrals import ReferralHandler
    >>>
    >>> # Automatic referral handling with authentication
    >>> referral_handler = ReferralHandler(
    ...     max_referral_depth=5,
    ...     rebind_credentials={"binddn": "cn=REDACTED_LDAP_BIND_PASSWORD", "password": "secret"}
    ... )
    >>>
...
from flext_ldaphaser import ReferralChaser, ReferralCredentials
