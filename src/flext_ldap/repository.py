...
class RepositoryBase[T_co](ABC):
    ...
    **Example Usage**:
    ```python
    from flext_ldap.repository import RepositoryBase
    from flext_core import FlextResult
    ...
    @abstractmethod
    def get_by_id(self, entity_id: ID_Type) -> FlextResult[T_co | None]:
    ...
    @abstractmethod
    def add(self, entity: T_in) -> FlextResult[T_co]:
    ...
    @abstractmethod
    def update(self, entity: T_in) -> FlextResult[T_co]:
    ...
    @abstractmethod
    def delete(self, entity_id: ID_Type) -> FlextResult[bool]:
    ...
    @abstractmethod
    def exists(self, entity_id: ID_Type) -> FlextResult[bool]:
