...
Example:
    ...
    >>> conditions = {"cn": "REDACTED_LDAP_BIND_PASSWORD", "objectClass": "person"}
    ...
    >>> print(components[0])
    {'attribute': 'cn', 'value': 'REDACTED_LDAP_BIND_PASSWORD'}
...
def flext_ldap_escape_filter_chars(value: str) -> str:
    ...
    Example:
        >>> flext_ldap_escape_filter_chars("user*(REDACTED_LDAP_BIND_PASSWORD)")
        'user\\2a(REDACTED_LDAP_BIND_PASSWORD\\29'
...
def flext_ldap_validate_dn(dn: str) -> bool:
    ...
    Example:
        >>> flext_ldap_validate_dn("cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com")
        True
