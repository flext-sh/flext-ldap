...
class FlextLdapAclConverters(FlextHandlers[object, FlextResult[object]]):
    ...
    def convert_acl(
        self, acl_content: str, source_format: str, target_format: str
    ) -> FlextResult[object]:
    ...
    class OpenLdapConverter(FlextHandlers[object, FlextResult[object]]):
        ...
        @staticmethod
        def to_microsoft_ad(acl_content: str) -> FlextResult[str]:
        ...
        @staticmethod
        def to_oracle(acl_content: str) -> FlextResult[str]:
    ...
    class MicrosoftAdConverter(FlextHandlers[object, FlextResult[object]]):
        ...
        @staticmethod
        def to_openldap(acl_content: str) -> FlextResult[str]:
