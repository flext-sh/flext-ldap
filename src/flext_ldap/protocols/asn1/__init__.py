...
Usage Example:
    >>> from flext_ldap.protocols.asn1 import ASN1Encoder, ASN1Decoder
    >>>
...
try:
    from flext_ldapsn1.codec import (  # type: ignore[import-not-found]
        ASN1Decoder,
        ASN1Encoder,
        BERCodec,
        DERCodec,
    )
    from flext_ldapsn1.constants import (  # type: ignore[import-not-found]
    ...
    from flext_ldapsn1.elements import (  # type: ignore[import-not-found]
        ASN1Choice,
        ASN1Element,
        ASN1Sequence,
        ASN1Set,
    )
    from flext_ldapsn1.schema import (  # type: ignore[import-not-found, attr-defined]
        ASN1Constraint,
        ASN1Module,
        ASN1Schema,
        ASN1SchemaCompiler,
    ...
    from flext_ldapsn1.types import (  # type: ignore[import-not-found, attr-defined]
    ...
    from flext_ldapsn1.utils import (  # type: ignore[import-not-found]
        asn1_decode,
        asn1_dump,
        asn1_encode,
        asn1_hexdump,
...
def new(**options: Any) -> Any:
    ...
    """
    try:
        from flext_ldapsn1.codec import ASN1Codec
