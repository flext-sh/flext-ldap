...
Usage Example:
    >>> from flext_ldap.protocols.sasl.mechanism import SASLMechanismRegistry
    >>>
...
class SASLMechanismRegistry:
    ...
    def _ensure_initialized(cls) -> None:
        ...
        try:
            from flext_ldapasl.mechanisms.plain import PlainMechanism
        ...
        try:
            from flext_ldapasl.mechanisms.digest_md5 import (
                DigestMD5Mechanism,
            )
        ...
        try:
            from flext_ldapasl.mechanisms.external import (
                ExternalMechanism,
            )
        ...
        try:
            from flext_ldapasl.mechanisms.anonymous import (
                AnonymousMechanism,
            )
