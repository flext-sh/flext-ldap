...
Usage:
    $ python -m flext_ldap.cli --help
    $ python -m flext_ldapldif --help
    $ python -m flext_ldaphema-manager --help
    $ python -m flext_ldapst --help

Example Commands:
    $ python -m flext_ldapldif input.schema output.ldif
    $ python -m flext_ldaphema-manager install custom.ldif
    $ python -m flext_ldapst --mechanism PLAIN --username test
"""
...
# CLI module imports
from flext_ldap.cli.asn1 import run_asn1_tool
from flext_ldap.cli.sasl import run_sasl_test
from flext_ldap.cli.schema import run_schema2ldif, run_schema_manager
...
def cli_main() -> None:
    """Entry point for python -m flext_ldap."""
    if CLICK_AVAILABLE:
        main()
    else:
        sys.exit(1)
