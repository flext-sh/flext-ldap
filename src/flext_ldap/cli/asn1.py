...
Example Usage:
    $ python -m flext_ldap.cli asn1-tool decode -i data.der -o data.txt
    $ python -m flext_ldapol dump -i data.der
"""
...
def _parse_asn1_schema(
    ...
    try:
        from flext_ldapsn1.schema import ASN1SchemaParser
...
def _compile_asn1_schema(
    ...
    try:
        from flext_ldapsn1.schema import (
            ASN1SchemaCompiler,
            ASN1SchemaParser,
        )
