...
Usage Example:
    >>> from flext_ldap.core import initialize_core, get_logger, LDAPCoreError
    >>>
...
# Core infrastructure imports - avoid circular imports
try:
    from flext_ldap.config.application_config import ApplicationConfig
    from flext_ldap.config.config_manager import ConfigManager
    from flext_ldap.config.environment import Environment
    from flext_ldap.config.log_level import LogLevel as ConfigLogLevel
except ImportError:
...
try:
    ...
    # Fallback for missing exceptions
    ConfigurationValidationError = Exception
    ErrorCategory = None
    ErrorSeverity = None
    LDAPCoreError = Exception
    OperationTimeoutError = Exception
    SchemaValidationError = Exception
    ValidationError = Exception
try:
    from flext_ldap.core.logging import (
        EventType,
        LoggerManager,
        PerformanceMonitor,
        SecurityEventType,
