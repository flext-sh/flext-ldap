...
Usage Example:
    >>> from flext_ldap.controls.proxy_auth import ProxyAuthorizationControl
    >>>
...
def proxy_as_admin() -> ProxyAuthorizationControl:
    """Create proxy control for admin user.

    Returns:
        ProxyAuthorizationControl for admin
...
#    - Integrate with flext_ldapty for proxy validation
