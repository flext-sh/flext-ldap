...
- **Location**: `src/flext_ldap/connections/base.py`
...
- **Location**: `src/flext_ldap/operations/compare.py`
...
- **Location**: `src/flext_ldap/protocols/sasl/mechanisms/digest_md5.py`
...
```python
from flext_ldap.connections.base import LDAPConnectionConfig
from flext_ldap.utils.constants import DEFAULT_PASSWORD_ATTRIBUTE
