    ...
    class LdapService:
        ...
        class LdapClientProtocol(Protocol):
            ...
            def search(
                ...
                server_type: str = "rfc",
            ) -> FlextProtocols.ResultProtocol[FlextLdapProtocols.Result.SearchResultProtocol]:
            ...
            ) -> FlextProtocols.ResultProtocol[FlextLdapProtocols.Result.OperationResultProtocol]:
                """Add LDAP entry.
