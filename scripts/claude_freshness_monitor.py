...
class CLAUDEFreshnessMonitor:
    ...
    def __init__(self, project_root: Path) -> None:
        ...
        self.monitored_files = [
            ...
            self.global_root / "internal.invalid.md",
            self.workspace_root / "CLAUDE.md",
            self.workspace_root / "internal.invalid.md",
            self.project_root / "internal.invalid.md",
        ]
        ...
        for file_path in self.monitored_files:
            ...
            for pattern in ref_patterns:
                ...
                for match in matches:
                    ...
                    if "CLAUDE.md" in ref_text or "internal.invalid.md" in ref_text:
    ...
    def generate_update_recommendations(self, freshness_results: list[dict]) -> list[str]:
        ...
        project_claude = next((f for f in freshness_results if "internal.invalid.md" in f["file"] and self.project_root.name in f["file"]), None)
        if project_claude and project_claude["freshness_level"] in {"STALE", "CRITICAL"}:
            recommendations.append("MEDIUM: Project internal.invalid.md requires update (project specifics)")
