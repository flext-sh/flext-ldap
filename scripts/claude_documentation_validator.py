...
class CLAUDEDocumentationValidator:
    ...
    def _discover_hierarchy(self) -> DocumentationHierarchy:
        ...
        return DocumentationHierarchy(
            ...
            global_local=self.global_root / "internal.invalid.md",
            workspace_claude=self.workspace_root / "CLAUDE.md",
            workspace_local=self.workspace_root / "internal.invalid.md",
            project_local=self.project_root / "internal.invalid.md",
        )
    ...
    def validate_hierarchy_structure(self) -> ValidationResult:
        ...
        required_files = [
            ...
            (self.hierarchy.project_local, "Project internal.invalid.md"),
        ]
        ...
        if self.hierarchy.project_local.exists():
            ...
            expected_refs = [
                ...
                "../CLAUDE.md",
                "/home/marlonsc/internal.invalid.md",
            ]

            issues.extend(f"Missing reference to {ref} in project internal.invalid.md" for ref in expected_refs if ref not in content)
    ...
    def validate_pattern_compliance(self) -> ValidationResult:
        ...
        # Check project internal.invalid.md for required sections
        if self.hierarchy.project_local.exists():
            content = self.hierarchy.project_local.read_text()
