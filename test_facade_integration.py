...
async def test_subsystem_integration() -> bool | None:
    ...
    try:
        ...
        config = LDAPConfig(
            ...
            auth_dn="cn=REDACTED_LDAP_BIND_PASSWORD,dc=enterprise,dc=com",
            auth_password="REDACTED_LDAP_BIND_PASSWORD123",
    ...
    try:
        ...
        for i in range(10):
            config = LDAPConfig(
                ...
                auth_dn=f"cn=REDACTED_LDAP_BIND_PASSWORD{i},dc=test,dc=com",
