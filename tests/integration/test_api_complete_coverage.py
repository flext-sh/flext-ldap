...
class TestDataFactories:
    ...
    @staticmethod
    def create_full_config(ldap_container: LdapContainerDict) -> FlextLdapConfig:
    ...
    @staticmethod
    def create_basic_config(ldap_container: LdapContainerDict) -> FlextLdapConfig:
    ...
    def create_test_entry(dn_suffix: str = "testservice") -> FlextLdifModels.Entry:
        ...
        user_data = FlextTestsFactories.create_user(
            user_id=dn_suffix,
            name="Test Service",
            email=f"{dn_suffix}@internal.invalid",
        )
