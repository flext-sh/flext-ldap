...
class TestRealLdifReadOperations:
    ...
    def test_parse_sample_user_ldif_to_entry(self, shared_ldif_data: str) -> None:
        ...
        attributes_dict: dict[str, FlextLdifModels.AttributeValues] = {
            ...
            "mail": FlextLdifModels.AttributeValues(values=["john.doe@internal.invalid"]),
        }
        ...
        assert entry.attributes.attributes["mail"].values == ["john.doe@internal.invalid"]
...
class TestRealLdifServerQuirks:
    ...
    def test_oracle_oud_attribute_handling(self) -> None:
        ...
        attributes_dict: dict[str, FlextLdifModels.AttributeValues] = {
            ...
            "sn": FlextLdifModels.AttributeValues(values=["User"]),
            "ds-privilege-name": FlextLdifModels.AttributeValues(values=["REDACTED_LDAP_BIND_PASSWORD"]),
        }
    ...
    def test_ldif_multi_valued_attributes_for_docker(self) -> None:
        ...
        attributes_dict: dict[str, FlextLdifModels.AttributeValues] = {
            ...
            "mail": FlextLdifModels.AttributeValues(
                values=["test1@internal.invalid", "test2@internal.invalid", "test3@internal.invalid"]
            ),
        }
        ...
        assert entry.attributes.attributes["mail"].values[0] == "test1@internal.invalid"
