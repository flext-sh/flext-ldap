...
class TestRealLdapOperations:
    ...
    def ldap_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "bind_dn": os.getenv("LDAP_TEST_BIND_DN", "cn=admin,dc=example,dc=org"),
...
async def test_ldap_connection_pooling() -> None:
    ...
    ldap_config = {
        "server_url": os.getenv("LDAP_TEST_SERVER", "ldap://localhost:389"),
        "bind_dn": os.getenv("LDAP_TEST_BIND_DN", "cn=admin,dc=flext,dc=local"),
        "password": os.getenv("LDAP_TEST_PASSWORD", "admin123"),
