    ...
    def test_complete_ldap_setup_workflow_integration(self) -> None:
        ...
        try:
            ...
            try:
                ...
                # Setup administrative authentication
                admin_auth_result = admin_sasl.select_mechanism("PLAIN")
                assert admin_auth_result.success, "Admin authentication setup failed"
                ...
                workflow_status = {
                    ...
                    "authentication_ready": admin_auth_result.success,
