...
class TestSharedLDAPIntegration:
    ...
    def test_shared_ldap_environment_variables(
        ...
        assert shared_ldap_config["bind_dn"] == "cn=REDACTED_LDAP_BIND_PASSWORD,dc=flext,dc=local"
    ...
    def test_shared_ldap_connection_config(
        ...
        assert shared_ldap_connection_config.bind_dn == "cn=REDACTED_LDAP_BIND_PASSWORD,dc=flext,dc=local"
