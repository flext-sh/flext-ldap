...
class TestFlextLdapSecurityEventData:
    ...
    def test_event_data_to_security_event(self) -> None:
        ...
        event_data = FlextLdapSecurityEventData(
            ...
            user_dn="cn=REDACTED_LDAP_BIND_PASSWORD,ou=users,dc=example,dc=com"
        )
        ...
        assert event.user_dn == "cn=REDACTED_LDAP_BIND_PASSWORD,ou=users,dc=example,dc=com"
...
class TestFlextLdapSecurityEventLogger:
    ...
    async def test_event_data_with_connection(self) -> None:
        ...
        assert event.user_dn == "cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com"
