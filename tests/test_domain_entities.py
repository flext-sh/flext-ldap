...
class TestFlextLdapGroup:
    ...
    def test_group_creation(self) -> None:
        ...
        assert group.dn == "cn=admins,ou=groups,dc=example,dc=org"
...
class TestFlextLdapConnection:
    ...
    def test_connection_creation(self) -> None:
        ...
        assert connection.bind_dn == "cn=admin,dc=example,dc=org"
    ...
    def test_connection_lifecycle(self) -> None:
        ...
        # Bind
        bound_connection = connected_connection.bind("cn=admin,dc=example,dc=org")
