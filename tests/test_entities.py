...
class TestFlextLdapGroup:
    ...
    def test_group_owner_management(self):
        ...
        # Test owner addition
        updated = group.add_owner("cn=admin,dc=example,dc=com")
        assert updated.is_owner("cn=admin,dc=example,dc=com")

        # Test owner removal
        removed = updated.remove_owner("cn=admin,dc=example,dc=com")
        assert not removed.is_owner("cn=admin,dc=example,dc=com")
...
class TestFlextLdapConnection:
    ...
    def test_connection_lifecycle(self):
        ...
        assert bound.bind_dn == "cn=admin,dc=example,dc=com"
