...
class TestWorkspaceStandardsCompliance:
    ...
    def test_workspace_coordination_patterns(self, workspace_coordination) -> None:
        """Test workspace coordination patterns as required by internal.invalid.md."""
        ...
        assert "client-a-oud-mig" in coordination["DEPENDENCY_FOR"]
    ...
    def test_dependent_projects_integration_validation(self) -> None:
        """Test dependent projects integration as required by internal.invalid.md."""
