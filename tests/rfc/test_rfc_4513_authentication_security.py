...
class TestRFC4513SimpleAuthentication:
    ...
    def test_simple_bind_mechanism(self) -> None:
        ...
        simple_bind = {
            "version": 3,
            "name": "cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com",  # Bind DN
            "authentication": {
    ...
    def test_simple_authentication_authorization(self) -> None:
        ...
        assert authenticated_authz.bind_dn == "cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com"
        assert authenticated_authz.is_authenticated is True
        assert authenticated_authz.authorization_level in {"user", "REDACTED_LDAP_BIND_PASSWORD"}
...
class TestRFC4513AuthorizationAndAccessControl:
    ...
    def test_authorization_identity_determination(self) -> None:
        ...
        auth_scenarios = [
            ...
            },
            {
                "auth_method": "simple",
                "bind_dn": "cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com",
                "expected_authz_id": "cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com",
            },
            {
                "auth_method": "SASL",
                "mechanism": "EXTERNAL",
    ...
    def test_access_control_evaluation(self) -> None:
        ...
        access_tests = [
            {
                "authz_id": "cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com",
                "operation": "search",
    ...
    def test_proxy_authorization(self) -> None:
        ...
        proxy_scenarios = [
            {
                "proxy_user": "cn=proxy-REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com",
            ...
            },
            {
                ...
                "target_user": "cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com",
                "operation": "modify",
                "proxy_allowed": False,  # Regular user cannot proxy REDACTED_LDAP_BIND_PASSWORD
            },
        ]
