        ...
        injection_attack_vectors = [
            {
                ...
                "malicious_input": "cn=admin,dc=example,dc=com)(|(password=*",
                "target_field": "search_base",
                "description": "DN injection in search base",
            },
            {
                "attack_type": "filter_injection",
                "malicious_input": "admin)(&(objectClass=*)(password=*",
            ...
            },
            {
                ...
                "malicious_input": "cn=test,dc=example,dc=com\\00\\0acn=admin,dc=example,dc=com",
                "target_field": "auth_dn",
                "description": "Null byte injection in bind DN",
            },
            {
                "attack_type": "password_injection",
                "malicious_input": "password\\x00admin_password",
