...
class TestDSMLConfiguration:
    ...
    def test_dsml_configuration_default_values(self) -> None:
        ...
        config = DSMLConfiguration(service_url="https://internal.invalid/REDACTED")

        assert config.service_url == "https://internal.invalid/REDACTED"
    ...
    def test_dsml_configuration_custom_values(self) -> None:
        ...
        config = DSMLConfiguration(
            service_url="https://internal.invalid/REDACTED",
...
class TestDSMLProtocol:
    ...
    def dsml_config(self) -> DSMLConfiguration:
        ...
        return DSMLConfiguration(service_url="https://internal.invalid/REDACTED")
    ...
    async def test_dsml_protocol_connect_success(self, mock_transport_class: MagicMock, dsml_protocol: DSMLProtocol) -> None:
        ...
        await dsml_protocol.connect("https://internal.invalid/REDACTED")
...
class TestDSMLConnection:
    ...
    def test_dsml_connection_initialization(self, dsml_connection: DSMLConnection) -> None:
        ...
        assert dsml_connection._service_url == "https://internal.invalid/REDACTED"
    ...
    async def test_dsml_connection_connect_success(self, mock_protocol_class: MagicMock, dsml_connection: DSMLConnection) -> None:
        ...
        mock_protocol.connect.assert_called_once_with("https://internal.invalid/REDACTED")
    ...
    def test_dsml_connection_get_connection_info(self, dsml_connection: DSMLConnection) -> None:
        ...
        assert info["service_url"] == "https://internal.invalid/REDACTED"
    ...
    def test_dsml_connection_properties(self, dsml_connection: DSMLConnection) -> None:
        ...
        assert dsml_connection.service_url == "https://internal.invalid/REDACTED"
...
class TestDSMLHelperFunctions:
    ...
    def test_create_dsml_connection(self) -> None:
        ...
        assert connection.service_url == "https://internal.invalid/REDACTED"

    def test_create_dsml_connection_minimal(self) -> None:
        """Test create_dsml_connection with minimal parameters."""
        connection = create_dsml_connection("https://internal.invalid/REDACTED")
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
    ...
    async def test_test_dsml_service_success(self, mock_session_class: MagicMock) -> None:
        ...
        result = await test_dsml_service("https://internal.invalid/REDACTED")
