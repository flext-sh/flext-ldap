...
class TestReferralCredentials:
    ...
    def test_credentials_creation_simple(self) -> None:
        ...
        assert credentials.credential_type == CredentialType.SIMPLE
        assert credentials.bind_dn == "cn=admin,dc=example,dc=com"
    ...
    def test_credentials_creation_sasl(self) -> None:
        ...
        credentials = ReferralCredentials(
            ...
            sasl_authz_id="admin@example.com",
        )
        ...
        assert credentials.sasl_authz_id == "admin@example.com"
    ...
    def test_get_auth_summary_simple(self) -> None:
        ...
        assert summary == "Simple bind as cn=admin,dc=example,dc=com"
...
class TestConvenienceFunctions:
    ...
    def test_create_simple_credentials(self) -> None:
        ...
        credentials = create_simple_credentials("cn=admin,dc=example,dc=com", "admin_password")
...
class TestIntegrationScenarios:
    ...
    def test_multiple_credential_types_workflow(self) -> None:
        ...
        credential_configs = [
            ("simple", create_simple_credentials("cn=admin,dc=example,dc=com", "admin_password")),
