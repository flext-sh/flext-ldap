...
class TestReferralHandler:
    ...
    def test_handler_initialization_dict_credentials(self) -> None:
        ...
        assert handler._rebind_credentials.bind_dn == "cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com"
        assert handler._rebind_credentials.password == "REDACTED_LDAP_BIND_PASSWORD_password"
