...
and workspace venv coordination as required by CLAUDE.md and internal.invalid.md.
...
def validate_workspace_venv() -> None:
    ...
    # Validate LDAP3 availability as required by internal.invalid.md
    try:
        import ldap3
...
def workspace_coordination() -> dict[str, str]:
    ...
    file management and cross-project integration as required by internal.invalid.md.
    ...
    # Set project context as required by internal.invalid.md
    coordination_context.update(
        {
            "PROJECT_CONTEXT": "ldap-core-shared",
            "STATUS": "development-shared-library",
            "DEPENDENCY_FOR": "client-a-oud-mig,flx-ldap,tap-ldap,target-ldap",
...
def pytest_configure(config: pytest.Config) -> None:
    ...
    config.addinivalue_line(
        "markers",
        "client-a_integration: Tests specific to client-a-oud-mig integration",
    )
