...
class TestFlextLDAPClientRealExecution:
    ...
    async def test_connect_parses_uri_real(self) -> None:
        ...
        with (
            ...
            result = await client.connect("ldap://testhost:389", "cn=REDACTED_LDAP_BIND_PASSWORD", "password")
    ...
    async def test_connect_handles_ldaps_uri_real(self) -> None:
        ...
        with (
            ...
            result = await client.connect(
                "ldaps://secure.example.com:636", "cn=REDACTED_LDAP_BIND_PASSWORD", "password"
            )
    ...
    async def test_connect_handles_default_ports_real(self) -> None:
        ...
        with (
            ...
            await client.connect("ldap://example.com", "cn=REDACTED_LDAP_BIND_PASSWORD", "password")
            ...
            await client.connect("ldaps://example.com", "cn=REDACTED_LDAP_BIND_PASSWORD", "password")
    ...
    async def test_connect_handles_ldap_exception_real(self) -> None:
        ...
        with patch("flext_ldap.clients.ldap3.Server") as mock_server_class:
            ...
            result = await client.connect("ldap://badhost", "cn=REDACTED_LDAP_BIND_PASSWORD", "password")
    ...
    async def test_connect_handles_generic_exception_real(self) -> None:
        ...
        with patch("flext_ldap.clients.ldap3.Server") as mock_server_class:
            ...
            # Execute real exception handling
            result = await client.connect("invalid://uri", "cn=REDACTED_LDAP_BIND_PASSWORD", "password")
    ...
    async def test_full_operation_flow_real(self) -> None:
        ...
        with (
            ...
            connect_result = await client.connect(
                "ldap://example.com", "cn=REDACTED_LDAP_BIND_PASSWORD", "password"
            )
