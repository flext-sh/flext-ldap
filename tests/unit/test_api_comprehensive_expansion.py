"""Comprehensive API coverage expansion tests.

Following COMPREHENSIVE_QUALITY_REFACTORING_PROMPT.md:
- Target API.py (168 statements, 42% coverage) for maximum impact
- Focus on REAL functional testing, not mocks
