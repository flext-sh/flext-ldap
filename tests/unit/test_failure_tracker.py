...
class TestLogFailure:
    ...
    def test_log_failure_writes_correct_format(self, tmp_path: Path) -> None:
        ...
        with failures_file.open("r", encoding="utf-8") as f:
            ...
            assert failure["dn"] == "cn=test,dc=algar"
    ...
    def test_log_multiple_failures(self, tmp_path: Path) -> None:
        ...
        tracker.log_failure("cn=user1,dc=algar", "users", "create", "Error 1")
        tracker.log_failure("cn=user2,dc=algar", "users", "update", "Error 2")
        tracker.log_failure("cn=group1,dc=algar", "groups", "create", "Error 3")
...
class TestGetFailuresByPhase:
    ...
    def test_get_failures_excludes_resolved(self, tmp_path: Path) -> None:
        ...
        tracker.log_failure("cn=test1,dc=algar", "users", "create", "Error")
        tracker.log_failure("cn=test2,dc=algar", "users", "create", "Error")
...
class TestGetAllFailures:
    ...
    def test_get_all_failures_excludes_resolved(self, tmp_path: Path) -> None:
        ...
        tracker.log_failure("cn=test1,dc=algar", "users", "create", "Error")
        tracker.log_failure("cn=test2,dc=algar", "groups", "create", "Error")
...
class TestMarkResolved:
    ...
    def test_mark_resolved_success(self, tmp_path: Path) -> None:
        ...
        result = tracker.mark_resolved("cn=test,dc=algar", "users")
    ...
    def test_mark_resolved_not_found_fails(self, tmp_path: Path) -> None:
        ...
        result = tracker.mark_resolved("cn=test2,dc=algar", "users")
...
class TestIncrementRetryCount:
    ...
    def test_increment_retry_count_success(self, tmp_path: Path) -> None:
        ...
        result = tracker.increment_retry_count("cn=test,dc=algar", "users")
    ...
    def test_increment_retry_count_not_found_fails(self, tmp_path: Path) -> None:
        ...
        result = tracker.increment_retry_count("cn=test2,dc=algar", "users")
...
class TestGenerateReport:
    ...
    def test_generate_report_with_failures(self, tmp_path: Path) -> None:
        ...
        tracker.log_failure("cn=user1,dc=algar", "users", "create", "Error A")
        tracker.log_failure("cn=user2,dc=algar", "users", "update", "Error A")
        tracker.log_failure("cn=group1,dc=algar", "groups", "create", "Error B")
    ...
    def test_generate_report_by_phase(self, tmp_path: Path) -> None:
        ...
        tracker.log_failure("cn=user1,dc=algar", "users", "create", "Error")
        tracker.log_failure("cn=user2,dc=algar", "users", "create", "Error")
        tracker.log_failure("cn=group1,dc=algar", "groups", "create", "Error")
    ...
    def test_generate_report_by_operation(self, tmp_path: Path) -> None:
        ...
        tracker.log_failure("cn=test1,dc=algar", "users", "create", "Error")
        tracker.log_failure("cn=test2,dc=algar", "users", "create", "Error")
        tracker.log_failure("cn=test3,dc=algar", "users", "update", "Error")
    ...
    def test_generate_report_most_common_errors(self, tmp_path: Path) -> None:
        ...
        tracker.log_failure("cn=test1,dc=algar", "users", "create", "Error A")
        tracker.log_failure("cn=test2,dc=algar", "users", "create", "Error A")
        tracker.log_failure("cn=test3,dc=algar", "users", "create", "Error B")
...
class TestClearResolved:
    ...
    def test_clear_resolved_removes_resolved(self, tmp_path: Path) -> None:
        ...
        with failures_file.open("r", encoding="utf-8") as f:
            ...
            assert failure["dn"] == "cn=test2,dc=algar"
