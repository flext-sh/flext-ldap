...
class TestsFlextLdapModels:
    ...
    def test_search_options_required_base_dn(self) -> None:
        ...
        with pytest.raises(ValidationError, match="base_dn"):
            m.SearchOptions(base_dn="")  # Empty string should fail validation
