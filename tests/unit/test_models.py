...
class TestFlextLdapModels:
    ...
    def test_acl_subject_model(self) -> None:
        ...
        assert acl_subject.identifier == "uid=admin,ou=people,dc=example,dc=com"
    ...
    def test_aci_format_parsing(self) -> None:
        ...
        aci = FlextLdapModels.AciFormat(
            ...
            grant_type="allow",
            permissions=["read", "write", "search"],
            bind_rules={"userdn": "ldap:///uid=admin,ou=people,dc=example,dc=com"},
        )
    ...
    def test_group_to_ldap_attributes(self) -> None:
        ...
        group = FlextLdapModels.Group(
            dn="cn=admins,ou=groups,dc=example,dc=com",
            cn="admins",
            member_dns=["uid=admin1,ou=users,dc=example,dc=com", "uid=admin2,ou=users,dc=example,dc=com"],
