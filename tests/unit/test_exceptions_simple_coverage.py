...
class TestFlextLdapExceptionsBasicCoverage(unittest.TestCase):
    ...
    def test_connection_error_with_parameters(self) -> None:
        ...
        error1 = FlextLdapConnectionError("Connection timeout", server_uri="ldap://ldap.example.com:389")
    ...
    def test_exception_factory_connection_methods(self) -> None:
        ...
        try:
            error1 = FlextLdapExceptionFactory.connection_failed("ldap.example.com", "Connection refused")
            assert isinstance(error1, FlextLdapConnectionError)
    ...
    def test_exception_factory_search_methods(self) -> None:
        ...
        try:
            error1 = FlextLdapExceptionFactory.search_failed("ou=users,dc=example,dc=com", "(uid=test)", "Invalid filter")
    ...
    def test_exception_factory_user_methods(self) -> None:
        ...
        try:
            error1 = FlextLdapExceptionFactory.user_creation_failed("cn=user,ou=users,dc=example,dc=com", "User exists")
    ...
    def test_exception_factory_validation_methods(self) -> None:
        ...
        try:
            error1 = FlextLdapExceptionFactory.validation_failed("mail", "Invalid email format")
    ...
    def test_exception_factory_configuration_methods(self) -> None:
        ...
        try:
            error1 = FlextLdapExceptionFactory.configuration_error("server", "Missing server configuration")
