...
class TestFlextLdapConfig:
    ...
    def test_create_connection_config_success(
        self,
        ldap_server_config: FlextCore.Types.Dict,
    ) -> None:
    ...
    def test_create_connection_config_with_minimal_data(
        ...
        minimal_config: FlextCore.Types.Dict = {
    ...
    def test_create_search_config_success(self) -> None:
        ...
        search_data: FlextCore.Types.Dict = {
    ...
    def test_create_search_config_validation_failure(self) -> None:
        ...
        invalid_data: FlextCore.Types.Dict = {
            "base_dn": None,
            "filter_str": None,
            "attributes": "invalid",
        }
    ...
    def test_create_modify_config_success(self) -> None:
        ...
        modify_data: FlextCore.Types.Dict = {
    ...
    def test_create_modify_config_validation_failure(self) -> None:
        ...
        data_with_types: FlextCore.Types.Dict = {
            "dn": None,
            "operation": None,
            "attribute": None,
    ...
    def test_create_add_config_type_conversion(self) -> None:
        ...
        # Test with data that needs type conversion
        data_with_types: FlextCore.Types.Dict = {"dn": None, "attributes": "invalid"}
    ...
    def test_create_delete_config_success(self) -> None:
        ...
        delete_data: FlextCore.Types.Dict = {
            "dn": "uid=testuser,ou=people,dc=example,dc=com"
        }
    ...
    def test_create_delete_config_validation_failure(self) -> None:
        ...
        invalid_data: FlextCore.Types.Dict = {"dn": None}
    ...
    def test_validate_connection_data_failure(self) -> None:
        ...
        invalid_data: FlextCore.Types.Dict = {"invalid": "data"}
    ...
    def test_validate_connection_data_missing_required_fields(self) -> None:
        ...
        incomplete_data: FlextCore.Types.Dict = {
            "server": "localhost"
    ...
    def test_config_integration_complete_workflow(self) -> None:
        ...
        conn_config: FlextCore.Types.Dict = {
            "server": "ldap://localhost",
            "port": FlextLdapConstants.Protocol.DEFAULT_PORT,
            "bind_dn": "cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com",
            "bind_password": "REDACTED_LDAP_BIND_PASSWORD123",
        ...
        search_config: FlextCore.Types.Dict = {
            "base_dn": "dc=example,dc=com",
            "filter_str": "(objectClass=person)",
            "attributes": ["cn", "sn", "mail"],
        }
        ...
        add_config: FlextCore.Types.Dict = {
            "dn": "uid=testuser,ou=people,dc=example,dc=com",
    ...
    def test_merge_configs(self) -> None:
        ...
        configs = FlextLdapConfig()
        base_config: FlextCore.Types.Dict = {"server": "ldap://localhost", "port": 389}
        override_config: FlextCore.Types.Dict = {"port": 636, "use_ssl": True}
...
class TestDirectAccessDotNotation:
    ...
    def test_call_operation_size_limit(self) -> None:
        ...
        config = FlextLdapConfig(ldap_size_limit=500, ldap_bind_password="test")
    ...
    def test_call_mask_passwords(self) -> None:
        ...
        config = FlextLdapConfig(ldap_mask_passwords=False, ldap_bind_password="test")
    ...
    def test_call_connection_server(self) -> None:
        ...
        config = FlextLdapConfig(
            ldap_server_uri="ldaps://internal.invalid", ldap_bind_password="test"
        )
    ...
    def test_call_connection_port(self) -> None:
        ...
        config = FlextLdapConfig(ldap_port=636, ldap_bind_password="test")
        assert config("ldap.connection.port") == 636

    def test_call_connection_ssl(self) -> None:
        """Test __call__ with ldap.connection.ssl."""
        config = FlextLdapConfig(ldap_use_ssl=True, ldap_bind_password="test")
    ...
    def test_call_connection_timeout(self) -> None:
        ...
        config = FlextLdapConfig(ldap_connection_timeout=45, ldap_bind_password="test")
    ...
    def test_call_auth_bind_dn(self) -> None:
        ...
        config = FlextLdapConfig(
            ldap_bind_dn="cn=REDACTED_LDAP_BIND_PASSWORD,dc=test,dc=com", ldap_bind_password="test"
        )
    ...
    def test_call_auth_base_dn(self) -> None:
        ...
        config = FlextLdapConfig(
            ldap_base_dn="dc=test,dc=com", ldap_bind_password="test"
        )
    ...
    def test_call_fallback_to_super(self) -> None:
        ...
        config = FlextLdapConfig(ldap_bind_password="test")
