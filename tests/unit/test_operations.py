...
class TestFlextLDAPSearchOperationsReal:
    ...
    def test_build_group_filter_real(self) -> None:
        ...
        # Test with criteria
        filter_str = ops._build_group_filter({"cn": "admin", "description": "test"})
...
class TestFlextLDAPGroupOperationsReal:
    ...
    def test_build_group_attributes_real(self) -> None:
        ...
        attributes = ops._build_group_attributes(
            cn="admins",
            description="Administrator group",
            members=["cn=admin,ou=users,dc=example,dc=com"],
        )
        ...
        assert attributes["member"] == ["cn=admin,ou=users,dc=example,dc=com"]
    ...
    def test_build_group_entity_real(self) -> None:
        ...
        assert "cn=admin,ou=users,dc=example,dc=com" in group.members
