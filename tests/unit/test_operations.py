...
class TestsFlextLdapOperations:
    ...
    def test_is_connected_not_connected(self) -> None:
        ...
        operations = self._create_operations()
        u.Tests.Matchers.that(operations.is_connected, eq=False)
