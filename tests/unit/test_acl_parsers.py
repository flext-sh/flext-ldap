...
from flext_ldap import FlextLdapAclConstants, FlextLdapAclParsers
...
class TestOracleAclParser:
    ...
    def test_parse_simple_oracle_acl(self) -> None:
        ...
        acl = 'access to attr=(userPassword) by group="cn=REDACTED_LDAP_BIND_PASSWORDs" (read,write)'
    ...
    def test_parse_oracle_entry_acl(self) -> None:
        ...
        acl = 'access to entry by user="cn=REDACTED_LDAP_BIND_PASSWORD" (read,write,delete)'
        result = FlextLdapAclParsers.OracleAclParser.parse(acl)
...
class TestAciParser:
    ...
    def test_parse_aci_with_group(self) -> None:
        ...
        aci = (
            ...
            '(version 3.0; acl "Group Access"; allow (read,write) groupdn="ldap:///cn=REDACTED_LDAP_BIND_PASSWORDs,ou=groups,dc=example,dc=com";)'
        )
        result = FlextLdapAclParsers.AciParser.parse(aci)
