...
class TestExceptionStringRepresentations:
    ...
    def test_ldap_error_with_operation_and_code(self) -> None:
        ...
        # FlextExceptions.BaseError format: [FLEXT_0001] message
        assert "[FLEXT_0001]" in result_str
    ...
    def test_connection_error_with_ldap_code(self) -> None:
        ...
        # FlextExceptions.ConnectionError format: [FLEXT_2001] message
        assert "[FLEXT_2001]" in result_str
    ...
    def test_validation_error_with_field_details(self) -> None:
        ...
        # FlextExceptions.ValidationError format: [FLEXT_3001] message
        assert "[FLEXT_3001]" in result_str
    ...
    def test_configuration_error_with_section(self) -> None:
        ...
        # FlextExceptions.ConfigurationError format: [FLEXT_2003] message
        assert "[FLEXT_2003]" in result_str
