...
class TestVersionExports:
    ...
    def test_version_tuple_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __version_tuple__
    ...
    def test_project_name_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __project__
    ...
    def test_description_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __description__
    ...
    def test_author_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __author__
    ...
    def test_author_email_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __author_email__
    ...
    def test_email_alias_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __email__
    ...
    def test_maintainer_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __maintainer__
    ...
    def test_maintainer_email_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __maintainer_email__
    ...
    def test_license_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __license__
    ...
    def test_copyright_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __copyright__
    ...
    def test_build_info_exists(self) -> None:
        ...
        from flext_ldap.__version__ import __branch__, __build__, __commit__
...
class TestVersionInfo:
    ...
    def test_version_tuple_equals_version_info(self) -> None:
        ...
        from flext_ldap.__version__ import __version_info__, __version_tuple__
...
class TestMetadataReading:
    ...
    def test_email_equals_author_email(self) -> None:
        ...
        from flext_ldap.__version__ import __author_email__, __email__
...
class TestExportedSymbols:
    ...
    def test_all_symbols_are_exported(self) -> None:
        ...
        for symbol in expected_symbols:
            assert symbol in __all__, f"Missing {symbol} in __all__"

    def test_exported_symbols_exist(self) -> None:
        """Test all symbols in __all__ actually exist."""
        from flext_ldap import __version__ as version_module

        for symbol in version_module.__all__:
            assert hasattr(version_module, symbol), f"Missing attribute {symbol}"
