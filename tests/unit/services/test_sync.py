...
class TestFlextLdapSyncServiceUnit:
    ...
    def test_sync_ldif_file_parse_failure(self) -> None:
        ...
        try:
            ...
            with patch.object(
                ...
                with patch(
                    ...
                    result = sync_service.sync_ldif_file(test_file)
    ...
    def test_sync_ldif_file_sync_batch_failure(self) -> None:
        ...
        try:
            ...
            with patch.object(
                ...
                # Mock flext-ldif parse to return success with entries
                ...
                with patch(
                    ...
                    with patch.object(
                        ...
                        assert result.is_failure
                        assert "Batch sync failed" in (result.error or "")
        finally:
            if test_file.exists():
                test_file.unlink()
