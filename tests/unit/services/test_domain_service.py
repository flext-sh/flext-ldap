...
class TestDomainServicesGroupMembership:
    ...
    @pytest.mark.unit
    def test_group_membership_valid_REDACTED_LDAP_BIND_PASSWORD_with_email(self) -> None:
        """Test valid membership in REDACTED_LDAP_BIND_PASSWORD group with email address."""
        user_dn = FlextLdifModels.DistinguishedName.model_validate({
            "value": "cn=REDACTED_LDAP_BIND_PASSWORD.user,ou=users,dc=example,dc=com"
        })
        user_attrs_dict = {"mail": ["REDACTED_LDAP_BIND_PASSWORD.user@example.com"]}
        ...
        group_dn = FlextLdifModels.DistinguishedName.model_validate({
            "value": "cn=REDACTED_LDAP_BIND_PASSWORD,ou=groups,dc=example,dc=com"
        })
        group_attrs_dict = {"cn": ["REDACTED_LDAP_BIND_PASSWORD"]}
    ...
    @pytest.mark.unit
    def test_group_membership_invalid_REDACTED_LDAP_BIND_PASSWORD_without_email(self) -> None:
        """Test invalid membership in REDACTED_LDAP_BIND_PASSWORD group without email address."""
        user_dn = FlextLdifModels.DistinguishedName.model_validate({
    ...
    def test_group_membership_valid_non_REDACTED_LDAP_BIND_PASSWORD_group(self) -> None:
        """Test valid membership in non-REDACTED_LDAP_BIND_PASSWORD group without email requirement."""
        user_dn = FlextLdifModels.DistinguishedName.model_validate({
    ...
    def test_group_membership_group_cn_case_insensitive(self) -> None:
        """Test REDACTED_LDAP_BIND_PASSWORD group detection is case insensitive."""
        user_dn = FlextLdifModels.DistinguishedName.model_validate({
