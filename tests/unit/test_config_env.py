...
class TestFlextLdapConfigEnvironment:
    ...
    def test_environment_variable_loading(self) -> None:
        ...
        os.environ["FLEXT_LDAP_BIND_DN"] = "cn=env-REDACTED_LDAP_BIND_PASSWORD,dc=test,dc=com"
        ...
        try:
            ...
            assert config.ldap_bind_dn == "cn=env-REDACTED_LDAP_BIND_PASSWORD,dc=test,dc=com"
