...
from flext_ldap.models import FlextLdapCreateUserRequest, FlextLdapEntry, FlextLdapGroup, FlextLdapUser
...
class TestFlextLdapOperationsBase:
    ...
    def test_handle_exception_with_context(self) -> None:
        ...
        result = ops._handle_exception_with_context("test operation", exception, "conn123")
...
class TestFlextLdapSearchOperations:
    ...
    async def test_search_groups_with_valid_parameters(self) -> None:
        ...
        result = await ops.search_groups(
            ...
            filter_criteria={"cn": "REDACTED_LDAP_BIND_PASSWORD"}
        )
    ...
    def test_build_group_filter_with_criteria(self) -> None:
        ...
        filter_str = ops._build_group_filter({"cn": "REDACTED_LDAP_BIND_PASSWORD"})
    ...
    def test_convert_entries_to_groups(self) -> None:
        ...
        assert groups[0].cn == "REDACTED_LDAP_BIND_PASSWORDs"
...
class TestFlextLdapGroupOperations:
    ...
    async def test_create_group_with_valid_data(self) -> None:
        ...
        assert result.value.cn == "REDACTED_LDAP_BIND_PASSWORDs"
    ...
    def test_handle_remove_member_not_found(self) -> None:
        ...
        current_members = ["cn=user1,dc=example,dc=com"]
        result = ops._handle_remove_member(current_members, "cn=user2,dc=example,dc=com")
    ...
    def test_handle_remove_member_last_member(self) -> None:
        ...
        current_members = ["cn=user1,dc=example,dc=com"]
        result = ops._handle_remove_member(current_members, "cn=user1,dc=example,dc=com")
