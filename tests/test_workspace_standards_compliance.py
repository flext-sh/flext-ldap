...
as defined in CLAUDE.md and internal.invalid.md, ensuring all LDAP core shared library
...
internal.invalid.md Standards Enforced:
    ...
    - Integration testing for client-a-oud-mig, flx-ldap, tap-ldap, target-ldap
...
class TestWorkspaceVenvCompliance:
    ...
    def test_ldap3_availability_in_workspace_venv(self) -> None:
        """Test LDAP3 availability in workspace venv as required by internal.invalid.md."""
        try:
            import ldap3
            ...
            pytest.fail(
                f"internal.invalid.md VIOLATION: LDAP3 not available in workspace venv!\n"
...
class TestEnvSecurityCompliance:
    ...
    def test_ldap_specific_env_security_patterns(self) -> None:
        """Test LDAP-specific .env security patterns as required by internal.invalid.md."""
...
class TestWorkspaceCoordinationCompliance:
    """Test workspace coordination compliance as required by internal.invalid.md."""
    ...
    def test_dependent_projects_coordination(self, workspace_coordination) -> None:
        """Test dependent projects coordination as required by internal.invalid.md."""
        coordination = workspace_coordination
...
class TestLDAPSpecificCompliancePatterns:
    """Test LDAP-specific compliance patterns as required by internal.invalid.md."""
    ...
    def test_ldap_quality_gates_validation(self) -> None:
        """Test LDAP quality gates validation as required by internal.invalid.md."""
