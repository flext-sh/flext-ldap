...
Test Coverage:
    ...
    - Self-service and administrative password operations
...
class TestModifyPasswordExtension:
    ...
    def test_extension_initialization_admin_reset(self) -> None:
        """Test extension initialization for admin reset."""
        extension = ModifyPasswordExtension(
    ...
    def test_encode_request_value_admin_reset(self) -> None:
        """Test encoding request value for admin reset."""
        extension = ModifyPasswordExtension(
    ...
    def test_encode_request_value_with_all_fields(self) -> None:
        ...
        extension = ModifyPasswordExtension(
            user_identity="uid=admin,dc=example,dc=com",
    ...
    def test_admin_reset_class_method(self) -> None:
        """Test admin_reset class method."""
        user_dn = "uid=test,ou=people,dc=example,dc=com"
        extension = ModifyPasswordExtension.admin_reset(user_dn, "reset123")

        assert extension.user_identity == user_dn
        assert extension.old_password is None
        assert extension.new_password == "reset123"
        assert extension.is_admin_operation() is True
    ...
    def test_is_admin_operation_method(self) -> None:
        """Test is_admin_operation method."""
        # Self-service (no user identity)
        extension1 = ModifyPasswordExtension()
        assert extension1.is_admin_operation() is False

        # Admin operation (with user identity)
        extension2 = ModifyPasswordExtension(user_identity="uid=test,dc=example,dc=com")
        assert extension2.is_admin_operation() is True
    ...
    def test_str_representation_admin_reset(self) -> None:
        """Test string representation for admin reset."""
        ...
        str_repr = str(extension)
        assert str_repr == f"ModifyPassword(admin, reset for {user_dn})"

    def test_str_representation_admin_generate(self) -> None:
        """Test string representation for admin generation."""
        user_dn = "uid=test,dc=example,dc=com"
        extension = ModifyPasswordExtension(
            user_identity=user_dn,
            new_password=None,
        ...
        str_repr = str(extension)
        assert str_repr == f"ModifyPassword(admin, generate for {user_dn})"
...
class TestPasswordChangeBuilder:
    ...
    def test_builder_build_admin_reset(self) -> None:
        """Test builder build method for admin reset."""
        builder = PasswordChangeBuilder()
        user_dn = "uid=test,ou=people,dc=example,dc=com"
        extension = (
...
class TestIntegrationScenarios:
    ...
    def test_rfc_3062_compliance(self) -> None:
        ...
        extension2 = ModifyPasswordExtension.admin_reset(
    ...
    def test_multiple_operation_types(self) -> None:
        ...
        operations = [
            ...
            ("admin_reset", ModifyPasswordExtension.admin_reset("uid=test,dc=example,dc=com", "reset")),
