...
# Tenant 1 Groups
dn: cn=REDACTED_LDAP_BIND_PASSWORDs,ou=groups,ou=tenantA,dc=enterprise,dc=global
objectClass: top
...
dn: uid=ldap-REDACTED_LDAP_BIND_PASSWORD,ou=services,dc=enterprise,dc=global
objectClass: top
objectClass: account
objectClass: simpleSecurityObject
uid: ldap-REDACTED_LDAP_BIND_PASSWORD
description: Global LDAP Administrator
userPassword: {SSHA}global_REDACTED_LDAP_BIND_PASSWORD_hash
