...
class LdapTestDataLoader:
    ...
    TEST_ADMIN_DN = "cn=testREDACTED_LDAP_BIND_PASSWORD,ou=system,dc=flext,dc=local"
    ...
    def load_all_test_data(self) -> FlextResult[None]:
        ...
        - System entries (testREDACTED_LDAP_BIND_PASSWORD)
        ...
        try:
            ...
            self.connection.add(
                ...
                attributes={
                    ...
                    "sn": "User",
                    "givenName": "Test",
                    "mail": "testuser3@internal.invalid",
    ...
    def _create_system_entries(self) -> FlextResult[None]:
        ...
        try:
            # Create system test REDACTED_LDAP_BIND_PASSWORD entry
            self.connection.add(
                self.TEST_ADMIN_DN,
                object_class=["top", "inetOrgPerson"],
                attributes={
                    "cn": "testREDACTED_LDAP_BIND_PASSWORD",
                    "sn": "Admin",
                    "givenName": "Test",
                    "mail": "REDACTED_LDAP_BIND_PASSWORD@internal.invalid",
                    "userPassword": "REDACTED_LDAP_BIND_PASSWORD123",
                },
            )
            logger.debug(f"testREDACTED_LDAP_BIND_PASSWORD creation: {self.connection.result}")
    ...
    def verify_test_data_exists(self) -> FlextResult[dict[str, bool]]:
        ...
        try:
            ...
            entries_to_check = {
                ...
                "testREDACTED_LDAP_BIND_PASSWORD": self.TEST_ADMIN_DN,
