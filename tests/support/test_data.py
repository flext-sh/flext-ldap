...
SAMPLE_ACL_DATA: dict[str, object] = {
    "unified_acl": {
        ...
        "permissions": [
            {
                "subject": "uid=admin,ou=people,dc=example,dc=com",
                "subject_type": "user",
                "permissions": ["read", "write", "delete"],
                "scope": "subtree",
            },
            {
                "subject": "cn=admins,ou=groups,dc=example,dc=com",
                "subject_type": "group",
    ...
    "openldap_aci": 'target="ldap:///dc=example,dc=com" version 3.0; acl "admin access"; allow (read,write,delete) userdn="ldap:///uid=admin,ou=people,dc=example,dc=com";',
    "oracle_aci": 'target="dc=example,dc=com" version 3.0; acl "admin access"; allow (read,write,delete) userdn="uid=admin,ou=people,dc=example,dc=com";',
