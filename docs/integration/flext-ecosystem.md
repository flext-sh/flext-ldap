...
class FlextLdapAuthProvider(AuthProvider):
    ...
    def _extract_roles_from_groups(self, groups: List[str]) -> List[str]:
        ...
        for group_dn in groups:
            ...
            if \"cn=REDACTED_LDAP_BIND_PASSWORD\" in group_dn.lower():
                roles.append(\"REDACTED_LDAP_BIND_PASSWORD\")
...
*This integration guide is part of the FLEXT-LDAP documentation and follows FLEXT Framework integration standards.*