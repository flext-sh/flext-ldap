...
**flext-ldap** now provides complete universal LDAP support, allowing you to work with any LDAP server type (OpenLDAP 1.x, OpenLDAP 2.x, Oracle OID, Oracle OUD, Active Directory) through a unified interface.
