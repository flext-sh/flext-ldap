...
- [FLEXT-LDAP Architecture](#flext-ldap-architecture)
  - [🏗️ Four-Layer Universal Architecture](#-four-layer-universal-architecture)
  - [📦 Core Components](#-core-components)
    - [**1. Application Layer**](#1-application-layer)
      - [FlextLdap](#flextldap)
      - [FlextLdapClients](#flextldapclients)
