...
### 🖥️ **I want GUI tools/administration**
- 🎨 [GUI Tools Collection](reference/README.md#gui-tools) - Visual LDAP tools
- 🌐 [Web Interfaces](reference/README.md#web-interfaces) - Browser-based admin
- 📊 [Administration Tools](reference/README.md#administration-tools) - Management utilities
...
| **Directory Studio** | Complete LDAP IDE | Development & admin | [📁](reference/apache-directory-studio-source/) |
...
| **phpLDAPadmin** | Web interface | Web-based admin | [📁](reference/phpldapadmin-web-interface/) |
...
- **PHP**: [phpLDAPadmin](reference/phpldapadmin-web-interface/)
- **Node.js**: [ldapjs](reference/nodejs-ldapjs/)
- **Modern**: [Minimalist Web UI](reference/ldap-ui-minimalist-web/)

### 🖥️ **System Administrators**
- **Start**: [Admin Tools Hub](reference/README.md#administration-tools)
...
| 🖥️ **GUI Tools** | **15+** | Desktop and web administration |
...
- 🖥️ [GUI Tools](reference/README.md#gui-tools) - Visual administration
