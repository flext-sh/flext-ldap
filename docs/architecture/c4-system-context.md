...
Rel(flext_ldap, flext_core, "Uses", "r, DI patterns")
Rel(flext_ldap, flext_ldif, "Integrates with", "Entry models, servers")
...
- **FLEXT-Core**: Provides foundation patterns (r, DI, domain models)
