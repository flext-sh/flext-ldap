...
- [Deploy to documentation site](#deploy-to-documentation-site)
  - [📊 Architecture Metrics](#-architecture-metrics)
    ...
    - [**Quality Attributes Status**](#quality-attributes-status)
  - [🚀 Quick Navigation](#-quick-navigation)
    - [**For Architects and Tech Leads**](#for-architects-and-tech-leads)
    - [**For Developers**](#for-developers)
    - [**For Operations and DevOps**](#for-operations-and-devops)
...
_Enterprise-grade architecture documentation with modern tooling and best practices_
