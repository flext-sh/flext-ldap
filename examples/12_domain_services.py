...
def demonstrate_user_specification() -> None:
    ...
    valid_usernames = ["john_doe", "REDACTED_LDAP_BIND_PASSWORD123", "user-name", "test_user_123"]
...
def demonstrate_group_specification() -> None:
    ...
    valid_names = ["REDACTED_LDAP_BIND_PASSWORD_group", "users-team", "group123", "test_group"]
...
def demonstrate_domain_services() -> None:
    ...
    user_scenarios = [
        ...
        },
        {
            ...
            "user": FlextLdapModels.LdapUser(
                dn="cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com", uid="REDACTED_LDAP_BIND_PASSWORD", cn="REDACTED_LDAP_BIND_PASSWORD", sn="Admin"
            ),
            "expected": "REDACTED_LDAP_BIND_PASSWORD",
        },
    ]
