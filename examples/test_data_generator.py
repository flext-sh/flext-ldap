...
ROLES: Final[FlextCore.Types.StringList] = [
    ...
    "auditor",
    "security",
    "backup_REDACTED_LDAP_BIND_PASSWORD",
    "network_REDACTED_LDAP_BIND_PASSWORD",
    "db_REDACTED_LDAP_BIND_PASSWORD",
    "app_REDACTED_LDAP_BIND_PASSWORD",
    "sys_REDACTED_LDAP_BIND_PASSWORD",
    "devops",
    "sre",
    "consultant",
    "trainer",
