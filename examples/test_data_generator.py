...
ROLES: Final[list[str]] = [
    "REDACTED_LDAP_BIND_PASSWORD", "developer", "manager", "analyst", "architect",
    "designer", "tester", "operator", "auditor", "security",
    "backup_REDACTED_LDAP_BIND_PASSWORD", "network_REDACTED_LDAP_BIND_PASSWORD", "db_REDACTED_LDAP_BIND_PASSWORD", "app_REDACTED_LDAP_BIND_PASSWORD", "sys_REDACTED_LDAP_BIND_PASSWORD",
        ...
        for dept, count in users_per_dept.items():
            for _ in range(count):
                ...
                attributes: dict[str, str | FlextTypes.StringList] = {
                    ...
                    FlextLdapConstants.LdapAttributeNames.MAIL: f"{uid}@internal.invalid",
