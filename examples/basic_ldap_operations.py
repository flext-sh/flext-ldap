...
async def demonstrate_configuration() -> None:
    ...
    auth_config = FlextLdapAuthConfig(bind_dn="cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com", bind_password=SecretStr("secret"), use_anonymous_bind=False)
...
async def demonstrate_error_handling() -> None:
    ...
    invalid_auth = FlextLdapAuthConfig(bind_dn="cn=REDACTED_LDAP_BIND_PASSWORD,dc=example,dc=com", bind_password=SecretStr(""), use_anonymous_bind=False)
