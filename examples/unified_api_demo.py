...
async def demo_unified_api() -> None:
    ...
    async with LDAP(config) as ldap:
        ...
        await ldap.search_category().groups("admin*")
        ...
        await ldap.groups_category().find_by_name("admins")
...
"""
        ...
        await ldap.admin_category().get_server_capabilities()

        # Obter Root DSE
        await ldap.admin_category().get_root_dse()
